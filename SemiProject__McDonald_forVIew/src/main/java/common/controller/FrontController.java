...
@WebServlet(
      ...
      urlPatterns = { "*.run" }, 
      initParams = { 
            @WebInitParam(name = "propertyConfig", value = "C:/git/SemiProject__McDonald_forVIew/SemiProject__McDonald_forVIew/src/main/webapp/WEB-INF/Command.properties",
...
public class FrontController extends HttpServlet {
   ...
   // 모든 .run URL 에는 똑같이 찍힐 것이다. 
      ...
      try {
         ...
         System.out.println(" >>>C:/git/SemiProject__McDonald_forVIew/SemiProject__McDonald_forVIew/src/main/webapp/WEB-INF/Command.properties에 파일이 없습니다. <<< ");
         e.printStackTrace();
      } catch (IOException e) {
         e.printStackTrace();

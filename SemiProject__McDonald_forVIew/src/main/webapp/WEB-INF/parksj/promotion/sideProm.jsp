...
<div class="MCcontent">
	...
	<div class="container" style="width: 100%; position: relative; margin-bottom: 40px;" >
		...
		<div class="btnArea">
			<button type="button" onclick="location.href='<%= request.getContextPath()%>/promotion/burgerProm.run'" class="prev"></button>
			<a href="<%= request.getContextPath()%>/promotion/promotionMain.run" role="button" class="btnMC btnM"><span>목록보기</span></a>
			<button type="button" onclick="location.href='<%= request.getContextPath()%>/promotion/rewardProm.run'" class="next"></button>
		</div>

...
$(document).ready(function() { 
	...
	var accordion_tab = $('.accordion1 p'), accordion_content = $('.accordion1 div');
        ...
        $("button.prev").click(function(){
       	 ...
       	 location.href='<%= request.getContextPath()%>/detail/drinkView.run?item_no='+ prev_item_no;
        ...
        //       console.log("next_item_no : " + next_item_no); 
       	 ...
       	 location.href='<%= request.getContextPath()%>/detail/drinkView.run?item_no='+ next_item_no;

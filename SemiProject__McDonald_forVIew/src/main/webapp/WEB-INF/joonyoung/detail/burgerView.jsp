	...
	var accordion_tab = $('.accordion1 p'), accordion_content = $('.accordion1 div');
		...
		let prev_item_no = "";
             ...
             $("button.prev").click(function(){
            	 ...
            	 location.href='<%= request.getContextPath()%>/detail/burgerView.run?item_no='+ prev_item_no;
	         ...
	         //       console.log("next_item_no : " + next_item_no); 
  			...
  			$("button.next").click(function(){
            	 ...
            	 location.href='<%= request.getContextPath()%>/detail/burgerView.run?item_no='+ next_item_no;
